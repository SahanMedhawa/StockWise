			...
			<div class="card-body">
				<div class="modal">
					<div class="modal-content">
						<span class="close"><a href="Product-list">&times;</a></span>
						<form action="${product != null ? 'updateProduct' : 'insertProduct'}"
							method="post">
							<caption>
							...
							<fieldset class="form-group">
								<label for="price">Price</label> <br> <input
									type="number" placeholder="Price in Product"
							...
							<fieldset class="form-group">
								<label for="category">Category</label> <br> <input type="text"
									...
									value="<c:out value='${product.category}' />" id="category"
