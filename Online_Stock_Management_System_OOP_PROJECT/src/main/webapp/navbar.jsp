		...
		<div class="navigation">
			<ul>
				<li><a href="dashboard-view"> <span class="icon"> <ion-icon
					...
					</span> <span class="title">StockWise</span>
				</a></li>
				...
				<li><a href="supplier-list"> <span class="icon"> <ion-icon
					...
					</span> <span class="title">Suppliers</span>
				</a></li>

				<li><a href="purchase-list"> <span class="icon"> <ion-icon
								name="trending-down-outline"></ion-icon>
					</span> <span class="title">Purchases</span>
				</a></li>

				<li><a href="order-list"> <span class="icon"> <ion-icon
					...
					<div>
						...
						<div class="sub-menu-wrap" id="subMenu">
							...
							<div class="sub-menu">
								...
								<hr>
									<a href="dashboard-view"><button
										class="btn">Add User Accounts</button></a> <br>
								<a href="login.jsp"
