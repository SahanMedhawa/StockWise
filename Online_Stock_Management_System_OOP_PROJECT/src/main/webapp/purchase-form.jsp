...
<body>
	...
	<div class="container col-md-5">
			...
			<div class="card-body">
				<div id="myModal" class="modal">
					<div class="modal-content">
						<span class="close"><a href="purchase-list">&times;</a></span>
						<form action="${purchase != null ? 'updatePurchase' : 'insertPurchase'} "
							method="post">
							<caption>
								<h2>${purchase != null ? 'Edit Purchase Product' : 'Add New Purchase Product'}</h2>
							</caption>

							<c:if test="${purchase != null}">
								<input type="hidden" name="id"
									value="<c:out value='${purchase.id}' />" />
							</c:if>
		...
		<!--							<input
									...
									value="<c:out value='${purchase.products}' />" id="products"
									name="products" required="required">   -->
							</fieldset>
								...
								<label for="supplier">Supplier</label> <br> 							
									<select name="supplier" >
										<c:forEach var="supplier" items="${listSupplier}">
								            <option value="${supplier.name}" ><c:out value="${supplier.name}" /></option>
								       </c:forEach>
									</select>
							</fieldset>
							<br>
							<fieldset class="form-group">
								<label for="qty">Quantity</label> <br> <input type="number"
									...
									value="<c:out value='${purchase.qty}' />" id="qty" name="qty" required>
							</fieldset>
							...
							<fieldset class="form-group" id="dFieldset">
								<label for="date">Date</label> <br> <input type="date"
									value="<c:out value='${purchase.date}' />" id="date"
