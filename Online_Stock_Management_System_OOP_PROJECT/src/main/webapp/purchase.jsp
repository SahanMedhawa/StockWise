	...
	<div class="container2">
		<div class="box1">
			...
			<button type="button" class="button1">
				...
				<span class="button__text"><a href="newPurchase"
					class="btn-success">Add New Purchase</a></span>
			</button>
				...
				<tbody>
					<c:forEach var="purchase" items="${listPurchase}">
						...
						<tr>
							...
							<td><c:out value="${purchase.products}" /></td>
							<td><c:out value="${purchase.supplier}" /></td>
							<td><c:out value="${purchase.qty}" /></td>
							<td><c:out value="${purchase.date}" /></td>
							<td><a
								href="editPurchase?id=<c:out value='${purchase.id}' />"
								class="btn_E">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
								href="deletePurchase?id=<c:out value='${purchase.id}' />"
								class="btn_D" onclick="return confirmDelete(${purchase.id})">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
